...
export const Answers = () => {
  ...
  return (
    <div>
      ...
      {answers.familyHistory==="false"&& answers.geneticMutation==="false"&&answers.personalHistory==="false"&&answers.radiationBefore30?(
        <p>Your answers to the survey indicate that you may be categorized as under average risk for breast cancer.
        {answers.age==="0-40"?(
          <p>
      ...
      <p>
      Your answer(s) to the survey indicate that you might be at high risk for breast cancer.
      </p>
      }
